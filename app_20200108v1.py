...
df = pd.read_csv('symptoms3_medcab3.csv')
...
unpickled_df_test = pd.read_pickle("./symptommedembedv2.pkl")
...
def display_results(user_input):
    ...
    def predict(user_input):
        ...
        output_json = df_big_json.to_json(orient='index')
